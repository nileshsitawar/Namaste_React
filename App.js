...
const RestaurantCard =(props) => {
  ...
  return (
    <div className='res-card'>
      <img alt="res-card" src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_264,h_288,c_fill/" + resdata.data.cloudinaryImageId}
      />
...
// * not using key gives error of not giving key to same childs (not acceptable) <<<< index as a key <<<<<<<<<< unique id (is the best  practice)
